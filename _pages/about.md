...
<div style="margin-bottom: 40px;">
  <div style="display: flex; flex-direction: column; align-items: flex-start; margin-bottom: 20px;">
    ...
    <div style="display: flex; gap: 10px;">
      <a href="https://Xpeng1999.github.io/fiels/paper1.pdf" style="text-decoration: none; padding: 6px 12px; background-color: rgb(102, 8, 116); color: white; border-radius: 4px;">PDF</a>
